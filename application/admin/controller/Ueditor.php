...
class Ueditor extends Controller{
	public function index(){
        ...
        //$CONFIG = json_decode(preg_replace("/\/\*[\s\S]+?\*\//", "", file_get_contents("./static/hack/ueditor/php/config.json")), true);
        ...
        switch ($action) {
            ...
            case 'uploadimage':
		        ...
		        $result = $this->uploadFile($fieldName);
		        break;
            /* 上传涂鸦 */
            case 'uploadscrawl':
		        $config = array(
	...
	*/
	private function upBase64($config,$fieldName){
	    ...
	    $dirname = ROOT_PATH. '/public/uploads/scrawl/';
	    $file['filesize'] = strlen($img);
