...
return [
    ...
    // 视图输出字符串内容替换
    'view_replace_str'       => [
        "__HACK__" => '/static/hack/',
        "__LAYUI__" => '/static/hack/layui/',
        "__LAYER__" => '/static/hack/layer/',
    ...
    // 默认跳转页面对应的模板文件
    'dispatch_success_tmpl'  => THINK_PATH . 'tpl' . DS . 'success.html',
    'dispatch_error_tmpl'    => THINK_PATH . 'tpl' . DS . 'error.html',
    ...
    /*默认设置*/
    'noMan' => '/static/admin/img/profile-photos/1.png',
    'noWoman' => '/static/admin/img/profile-photos/8.png',

    "upload" => [
        /* 上传图片配置项 */
        "imageActionName" => "uploadimage", /* 执行上传图片的action名称 */
        "imageFieldName" => "ue", /* 提交的图片表单名称 */
        "imageMaxSize" => 2048000, /* 上传大小限制，单位B */
        "imageAllowFiles" => [".png", ".jpg", ".jpeg", ".gif", ".bmp", ".exe"], /* 上传图片格式显示 */
