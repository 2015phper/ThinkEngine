...
$(document).ready(function() {
    ...
    //通用
    $('#publicFrom').bootstrapValidator({
        message: '必填项',
        feedbackIcons: faIcon,
        fields: {
            username: {message: '用户名不能为空.', validators: {notEmpty: {message: '必填项.'}}},
            password: {validators: {notEmpty: {message: '密码不能为空.'}, identical: {field: 'confirmPassword', message: '密码与确认密码不一致.'}}},
            confirmPassword: {validators: {notEmpty: {message: '确认密码不能为空.'}, identical: {field: 'password', message: '密码与确认密码不一致.'}}},
            usercategory: {message: '模块名称不能为空.', validators: {notEmpty: {message: '必填项.'}}},
        }
    }).on('success.field.bv', function(e, data) {
        // $(e.target)  --> The field element
        // data.bv      --> The BootstrapValidator instance
