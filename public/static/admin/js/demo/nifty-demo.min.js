$(document).ready(function() {
    function l() {
        ...
        var n = document.getElementById("demo-box-lay"),
            t = document.getElementById("demo-box-img"),
            l = $("#demo-bg-boxed"),
            r = document.getElementById("demo-close-boxed-img"),
            c = $("#demo-blurred-bg"),
            f = $("#demo-polygon-bg"),
            d = $("#demo-abstract-bg");
        a.hasClass("boxed-layout") ? (n.checked = !0, t.disabled = !1) : (n.checked = !1, t.disabled = !0),
            n.onchange = function() {
                n.checked ? (a.addClass("boxed-layout"), t.disabled = !1) : (a.removeClass("boxed-layout").removeAttr("style"), t.disabled = !0, l.removeClass("open").find(".thumbnail").removeClass("selected")),
        ...
        var p = "easeInQuart easeOutQuart easeInBack easeOutBack easeInOutBack steps jumping rubber",
            v = document.getElementById("demo-anim"),
            g = document.getElementById("demo-ease");
        a.hasClass("effect") ? (v.checked = !0, g.disabled = !1) : (v.checked = !1, g.disabled = !0),
            v.onchange = function() {
        ...
        y.checked = a.hasClass("navbar-fixed") ? !0 : !1,
            y.onchange = function() {
                y.checked ? a.addClass("navbar-fixed") : a.removeClass("navbar-fixed"),
                    s.niftyAffix("update"),
                    o.niftyAffix("update")
            };
        var C = document.getElementById("demo-footer-fixed");
        C.checked = a.hasClass("footer-fixed") ? !0 : !1,
            C.onchange = function() {
                C.checked ? a.addClass("footer-fixed") : a.removeClass("footer-fixed")
            };
        var b = document.getElementById("demo-nav-coll"),
            T = document.getElementById("demo-nav-fixed"),
            x = document.getElementById("demo-nav-profile"),
            S = document.getElementById("demo-nav-shortcut"),
            w = document.getElementById("demo-nav-offcanvas"),
            k = $("#mainnav-profile"),
            E = $("#mainnav-shortcut");
        T.checked = a.hasClass("mainnav-fixed") ? !0 : !1,
            T.checked = a.hasClass("mainnav-fixed") ? !0 : !1,
            T.onchange = function() {
            ...
            S.checked = E.hasClass("hidden") ? !1 : !0,
            S.onchange = function() {
        ...
        var _ = document.getElementById("demo-asd-vis"),
            N = document.getElementById("demo-asd-fixed"),
            A = document.getElementById("demo-asd-float"),
            H = document.getElementById("demo-asd-align"),
            O = document.getElementById("demo-asd-themes");
        _.checked = a.hasClass("aside-in") ? !0 : !1,
            _.onchange = function() {
                $.niftyAside(_.checked ? "show": "hide")
            },
            N.checked = a.hasClass("aside-fixed") ? !0 : !1,
            N.onchange = function() {
            ...
            H.checked = a.hasClass("aside-left") ? !0 : !1,
            H.onchange = function() {
    ...
    var e = $("#demo-set"),
        a = ($("#demo-set-icon"), $("#demo-set-btngo"), $("#container")),
        s = $("#mainnav-container"),
        o = $("#aside-container");
    if (e.length) {
        var r = function() {
        ...
        $("html").on("click", function(n) {
            ...
            c.one("click", l),
            $("#demo-btn-close-settings").on("click",
                function() {
                    c.trigger("click")
                })
    }
