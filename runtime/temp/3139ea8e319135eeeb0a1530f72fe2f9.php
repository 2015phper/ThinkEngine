<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:86:"D:\wamp\www\120.79.12.123\ThinkEngine\public/../application/admin\view\flash\list.html";i:1512092452;s:24:"static/admin/navbar.html";i:1514944209;s:23:"static/admin/aside.html";i:1511141685;s:22:"static/admin/menu.html";i:1511605267;s:24:"static/admin/footer.html";i:1511745268;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
...
<head>
    ...
    <title>幻灯片列表 | TE.CMS - ThinkEngineCMS</title>
    <!--STYLESHEET-->
...
<!--END NAVBAR-->
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <!--Page Title-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">幻灯片管理</h1>
                ...
                <ol class="breadcrumb">
					...
					<li><a href="<?php echo url('flash/add'); ?>">新增</a></li>
					        ...
					        <div class="pad-btm form-inline">
                                <div class="row">
                                    <div class="col-sm-6 table-toolbar-left">
                                        <a class="btn btn-purple" href="<?php echo url('/admin/flash/add'); ?>"><i class="fa fa-plus-circle"></i> 新增</a>
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-danger" onclick="delChecked('<?php echo url('/admin/flash/delete'); ?>',this,'form-horizontal')" title="批量删除"><i class="fa fa-trash-o"></i></button>
                                        </div>
                                        <div class="btn-group">
                                    ...
                                    <div class="col-sm-6 table-toolbar-right">
                                        <form action="<?php echo url('/admin/flash/index'); ?>" method="get">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <?php if(!empty(\think\Request::instance()->get('keyword'))): ?><a href="<?php echo url('admin/flash/index'); ?>" class="btn btn-default">清空搜索</a><?php endif; ?>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<td><img class="img-circle img-sm" src="<?php echo $item['photo']; ?>" alt="<?php echo $item['desc']; ?>" layer-pid="<?php echo $item['id']; ?>" layer-src="<?php echo $item['photo']; ?>"></td>
...
<td><?php echo $item['rank']; ?></td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?php echo url('flash/edit', ['id'=>$item['id']]); ?>" class="btn-xs btn btn-dark">编辑</a>
                                                <a href="<?php echo url('flash/delete', ['id'=>$item['id']]); ?>" onClick='return confirm("确定要删除吗？");' class="btn-xs btn btn-danger">删除</a>
                                            </div>
                                        </td>
                                    </tr>
