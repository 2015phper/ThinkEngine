<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"D:\wamp\www\120.79.12.123\ThinkEngine\public/../application/admin\view\link\list.html";i:1511745266;s:24:"static/admin/navbar.html";i:1514944209;s:23:"static/admin/aside.html";i:1511141685;s:22:"static/admin/menu.html";i:1511605267;s:24:"static/admin/footer.html";i:1511745268;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <ol class="breadcrumb">
					...
					<li><a href="<?php echo url('link/add'); ?>">新增</a></li>
					    ...
					    <div class="panel-body">
					        <div class="pad-btm form-inline">
                                <div class="row">
                                    <div class="col-sm-6 table-toolbar-left">
                                        <a class="btn btn-purple" href="<?php echo url('admin/link/add'); ?>"><i class="demo-pli-add"></i> 新增</a>
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-danger" onclick="delChecked('<?php echo url('/admin/link/delete'); ?>',this,'form-horizontal')" title="批量删除"><i class="fa fa-trash-o"></i></button>
                                        </div>
                                        <div class="btn-group">
                                    ...
                                    <div class="col-sm-6 table-toolbar-right">
                                        <form action="<?php echo url('admin/link/index'); ?>" method="get">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <?php if(!empty(\think\Request::instance()->get('keyword'))): ?><a href="<?php echo url('admin/link/index'); ?>" class="btn btn-default">清空搜索</a><?php endif; ?>
                                                <div class="btn-group">
					        ...
					        <div class="table-responsive">
                                <table class="form-horizontal table table-bordered table-hover toggle-circle" data-page-size="7">
                                    ...
                                    <tr>
                                        <td>
                                            <input id="list-<?php echo $key; ?>" class="magic-checkbox id" type="checkbox" value="<?php echo $item['id']; ?>">
                                            <label for="list-<?php echo $key; ?>"></label>
                                        </td>
                                        <td><?php echo $item['id']; ?></td>
                                        <td><input class="form-control" type="text" value="<?php echo $item['name']; ?>" name="name"></td>
                                        <td><input class="form-control" type="text" value="<?php echo $item['url']; ?>" name="url"></td>
                                        <td><input class="sw-checked" type="checkbox" value="<?php echo $item['display']; ?>" name="display" <?php if($item['display'] == 1): ?>checked<?php endif; ?> ></td>
                                        <td><?php echo $link->getCateName($item['cid']); ?></td>
                                        <td><?php echo $item['rank']; ?></td>
                                        <td><?php echo date('Y-m-d H:i:s',$item['update_time']); ?></td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?php echo url('link/edit','&id='.$item['id']); ?>" class="btn-xs btn btn-dark">编辑</a>
                                                <a href="<?php echo url('link/delete','&id='.$item['id']); ?>" onClick='return confirm("确定要删除吗？");' class="btn-xs btn btn-danger">删除</a>
                                            </div>
                                        </td>
                                    </tr>
