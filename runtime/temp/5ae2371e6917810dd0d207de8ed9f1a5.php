<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:86:"D:\wamp\www\120.79.12.123\ThinkEngine\public/../application/admin\view\about\list.html";i:1511399614;s:24:"static/admin/navbar.html";i:1514944209;s:23:"static/admin/aside.html";i:1511141685;s:22:"static/admin/menu.html";i:1511605267;s:24:"static/admin/footer.html";i:1511745268;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>单页面管理 | TE.CMS - ThinkEngineCMS</title>
    <!--STYLESHEET-->
...
<!--END NAVBAR-->
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--Page Title-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">单页面列表</h1>
                ...
                <ol class="breadcrumb">
					...
					<li><a href="<?php echo url('about/add'); ?>">新增</a></li>
					        ...
					        <div class="pad-btm form-inline">
                                <div class="row">
                                    <div class="col-sm-6 table-toolbar-left">
                                        <a class="btn btn-purple" href="<?php echo url('admin/about/add'); ?>"><i class="demo-pli-add"></i> 新增</a>
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-danger" onclick="delChecked('<?php echo url('/admin/about/delete'); ?>',this,'form-horizontal')" title="批量删除"><i class="fa fa-trash-o"></i></button>
                                        </div>
                                        <div class="btn-group">
                                    ...
                                    <div class="col-sm-6 table-toolbar-right">
                                        <form action="<?php echo url('admin/about/index'); ?>" method="get">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <?php if(!empty(\think\Request::instance()->get('keyword'))): ?><a href="<?php echo url('admin/about/index'); ?>" class="btn btn-default">清空搜索</a><?php endif; ?>
                                            </div>
                                        </form>
                                    </div>
                                </div>
					        ...
					        <div class="table-responsive">
                                <table class="table table-bordered table-hover toggle-circle form-horizontal" data-page-size="7">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo url('/index/about/show', ['id'=>$item['id']]); ?>"><?php echo $item['id']; ?></a></td>
                                        <td><?php echo $item['title']; ?></td>
                                        <td><?php echo str_cut(KillAllHtml($item['content']),30); ?></td>
                                        <td><?php echo date('Y-m-d H:i:s',$item['create_time']); ?></td>
                                        <td><?php echo date('Y-m-d H:i:s',$item['update_time']); ?></td>
                                        <td><?php echo $item['rank']; ?></td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?php echo url('about/edit','&id='.$item['id']); ?>" class="btn-xs btn btn-dark">编辑</a>
                                                <a href="<?php echo url('about/delete','&id='.$item['id']); ?>" onClick='return confirm("确定要删除吗？");' class="btn-xs btn btn-danger">删除</a>
                                            </div>
                                        </td>
                                    </tr>
