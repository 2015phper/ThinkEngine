...
-- ----------------------------
DROP TABLE IF EXISTS `tc_auth_rule`;
CREATE TABLE `tc_auth_rule` (
...
-- ----------------------------
DROP TABLE IF EXISTS `tc_auth_group`;
    CREATE TABLE `tc_auth_group` (
    `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `tc_auth_group_access`;
    CREATE TABLE `tc_auth_group_access` (
...
class Auth
{
    ...
    {
        //可设置配置项 auth, 此配置项为数组。
        if ($auth = array_change_key_case(Config('AUTH_CONFIG'))) {
